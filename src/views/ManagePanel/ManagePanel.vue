<script setup>
import DashboardPage from '@/components/ManagementPanelParts/ManagerDashBoard/dashboardPage.vue'
import MovieList from '@/components/ManagementPanelParts/MovieList/MovieList.vue'
import AddMovie from '@/components/ManagementPanelParts/addMovie/AddMovie.vue'
import InFoReForm from '@/components/ManagementPanelParts/InfoReForm/InfoReForm.vue'
import UsersList from '@/components/ManagementPanelParts/UserList/UsersList.vue'
import UsersTickets from '@/components/ManagementPanelParts/tickets/UsersTickets.vue'
    ...
    <main class="d-flex flex-row">
      ...
      >
        ...
        >
          ...
          <!-- مدیریت محتوا-->
          <div
            class="SideBarLink w-100 mt-1 mb-2 d-flex flex-column align-items-start justify-content-center"
          >
          ...
          <div class="dropdownLinks d-none flex-column" ref="MediaBtn">
            <!-- افزودن  فیلم و سریال -->
            <div
              class="SideBarLink w-100 mt-1 mb-2 d-flex flex-column align-items-center justify-content-center"
            >
          ...
          <!-- تیکت ها-->
          <div
            class="SideBarLink w-100 mt-1 mb-3 d-flex flex-column align-items-start justify-content-center"
          >
            <button class="SideBarBtn box-bg p-2" :class="{
          ...
          <!-- خروج-->
          <div
            class="SideBarLink w-100 mt-1 mb-2 d-flex  align-items-start pt-0 pb-0 p-4"
          >
            <RouterLink :to="{name: 'HomePage'}" class="SideBarBtn box-bg align-self-start">
              <img src="../../assets/img/free_icon_3.svg" style="width: 32px;height: 32px;">
