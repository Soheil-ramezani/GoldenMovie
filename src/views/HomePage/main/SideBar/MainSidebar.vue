<template>
  <aside class="mainSite-sidebar d-inline-block">
            <div class="sidebar-box d-block w-100">
              <div  class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  <div  class="icon red d-inline-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-pen-nib"></i>
                  </div>
                  <div class="content">
                    <span class="d-block">سریال های بروز شده</span>
                    <samp class="d-block">Updated Series</samp>
                  </div>
                </div>
                <div class="info">
                  <a  href="https://demo.novinwp.com/digimedia/series/"  class="btn text-nowrap"  >تمام سریال ها</a>
                </div>
              </div>
            ...
            <div class="sidebar-box d-block w-100">
              <div  class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  <div  class="icon blue d-inline-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-masks-theater"></i>
                  </div>
                  <div class="content">
                    <span class="d-block">انتخاب ژانر</span>
                    <samp class="d-block">Choose a genre</samp>
                  </div>
                </div>
                <div class="info switchable-btn d-inline-flex">
                  <span  class="sbtn d-inline-flex align-items-center justify-content-center position-relative text-nowrap active"  data-id="movies"  >فیلم ها</span>
                  <span  class="sbtn d-inline-flex align-items-center justify-content-center position-relative text-nowrap"  data-id="series"  >سریال ها</span>
                </div>
              </div>
              <div class="box-content d-block position-relative">
                <ul  class="genre-list w-100 flex-wrap justify-content-between top-0 end-0"  data-list="movies">
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">اکشن</span>
                      <samp class="count d-inline-flex align-items-center"  >8</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center" href="#"  rel="tag">
                      <span class="title d-inline-block">بیوگرافی</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">تاریخی</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">جنایی</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center" href="#"  rel="tag">
                      <span class="title d-inline-block">درام</span>
                      <samp class="count d-inline-flex align-items-center"  >5</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center" href="#"  rel="tag">
                      <span class="title d-inline-block">علمی تخیلی</span>
                      <samp class="count d-inline-flex align-items-center"  >5</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">فانتزی</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">ماجراجویی</span>
                      <samp class="count d-inline-flex align-items-center"  >8</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">هیجان انگیز</span>
                      <samp class="count d-inline-flex align-items-center">2</samp>
                    </a>
                  </li>
                </ul>
                <ul  class="genre-list w-100 flex-wrap justify-content-between top-0 end-0"  data-list="series"  style="display: none">
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">Combat Sports</span>
                      <samp class="count d-inline-flex align-items-center"  >0</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">Sports</span>
                      <samp class="count d-inline-flex align-items-center"  >0</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">اکشن</span>
                      <samp class="count d-inline-flex align-items-center"  >3</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                  ...
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#" rel="tag">
                      <span class="title d-inline-block">ترسناک</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">جنایی</span>
                      <samp class="count d-inline-flex align-items-center"  >6</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">جنگی</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">درام</span>
                      <samp class="count d-inline-flex align-items-center"  >7</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">رازآلود</span>
                      <samp class="count d-inline-flex align-items-center"  >1</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">شومن</span>
                      <samp class="count d-inline-flex align-items-center"  >0</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">عاشقانه</span>
                      <samp class="count d-inline-flex align-items-center"  >0</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
                  ...
                  <li class="genre d-inline-block">
                    <a  class="w-100 d-flex justify-content-between align-items-center"  href="#"  rel="tag">
                      <span class="title d-inline-block">مستند</span>
                      <samp class="count d-inline-flex align-items-center"  >0</samp>
                    </a>
                  </li>
                  <li class="genre d-inline-block">
            ...
            <div class="sidebar-box d-block w-100">
              <div  class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  <div  class="icon yellow imdb d-inline-flex align-items-center justify-content-center">
                    <i class="imdb-icon"></i>
                  </div>
                  <div class="content">
                    <span class="d-block">250 فیلم برتر IMDb</span>
                    <samp class="d-block">Top 250 IMDb movies</samp>
                  </div>
                </div>
                <div class="info">
                  <a  href="#"  class="btn text-nowrap"  >مشاهده همه</a>
                </div>
              </div>
                ...
                <ul class="topmovies-list d-block w-100">
                  <li  class="top-item w-100 d-flex justify-content-between align-items-center">
                    ...
                    <div  class="content d-inline-block overflow-hidden text-nowrap">
                      ...
                      <div  class="post-genres d-flex overflow-hidden w-100 text-nowrap">
                        ...
                        <a  href="#"  rel="tag"  >درام</a>
                        <a  href="#"  rel="tag"  >ماجراجویی</a>
                      </div>
                    </div>
                    <a   class="showmore overflow-hidden d-inline-flex align-items-center justify-content-center"  href="#">
                      <svg class="icon">
                        <use xlink:href="#playb_icon">
                  ...
                  <li  class="top-item w-100 d-flex justify-content-between align-items-center">
                    ...
                    <div  class="content d-inline-block overflow-hidden text-nowrap">
                      ...
                      <div class="post-genres d-flex overflow-hidden w-100 text-nowrap">
                        <a  href="#"  rel="tag"  >بیوگرافی</a>
                        <a  href="#"  rel="tag"  >تاریخی</a>
                        <a  href="#"  rel="tag"  >درام</a>
                      </div>
                    </div>
                    <a  class="showmore overflow-hidden d-inline-flex align-items-center justify-content-center"  href="https://demo.novinwp.com/digimedia/movies/tt15398776/">
                      <svg class="icon">
                  ...
                  <li  class="top-item w-100 d-flex justify-content-between align-items-center">
                    ...
                    <div  class="content d-inline-block overflow-hidden text-nowrap">
                      ...
                      <div  class="post-genres d-flex overflow-hidden w-100 text-nowrap">
                        <a  href="https://demo.novinwp.com/digimedia/genre/%d8%a7%da%a9%d8%b4%d9%86/"  rel="tag"  >اکشن</a>
                        <a  href="#"  rel="tag"  >علمی تخیلی</a>
                        <a  href="#"  rel="tag"  >ماجراجویی</a>
                      </div>
                    </div>
                    <a  class="showmore overflow-hidden d-inline-flex align-items-center justify-content-center" href="#">
            ...
            <div class="sidebar-box d-block w-100">
              <div  class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  ...
                  <div class="content">
                    <span class="d-block">250 سریال برتر IMDb</span>
                    <samp class="d-block">Top 250 IMDb series</samp>
                  </div>
                </div>
                <div class="info">
                  <a  href="#"  class="btn text-nowrap"  >مشاهده همه</a>
                ...
                <ul class="topmovies-list d-block w-100">
                  <li  class="top-item w-100 d-flex justify-content-between align-items-center">
                    ...
                    <div  class="content d-inline-block overflow-hidden text-nowrap">
                      ...
                      <div  class="post-genres d-flex overflow-hidden w-100 text-nowrap">
                        <a  href="#"  rel="tag"  >جنایی</a>
                        <a  href="#"  rel="tag"  >درام</a>
                        <a  href="#"  rel="tag"  >هیجان انگیز</a
                        >
                      </div>
                    </div>
                    <a  href="#"  class="showmore overflow-hidden d-inline-flex align-items-center justify-content-center">
                      <svg class="icon">
                        <use xlink:href="#playb_icon"></use>
                      </svg>
                    </a>
            ...
            <div class="sidebar-box d-block w-100">
              <div  class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  <div  class="icon orange d-inline-flex align-items-center justify-content-center">
                    <i class="fa-regular fa-star"></i>
                  </div>
                  <div class="content">
                    <span class="d-block">اکشن ها</span>
                  </div>
                </div>
              </div>
              <div class="box-content d-block position-relative">
                <div class="post-slider one_half_slider">
                      ...
                      <div  class="swiper-slide"  style="width: 167px; margin-left: 1px"  role="group"  aria-label="1 / 10">
                        <a  href="#"  class="main-item w-100 d-block overflow-hidden position-relative">
                          ...
                          <div  class="img-cover w-100 h-100 position-absolute start-0 top-0">
                            ...
                            <div class="imdb-rate">
                              <svg  id="home_img"  class="ipc-logo"  xmlns="http://www.w3.org/2000/svg"  width="30"  height="30"  viewBox="0 0 64 32"  version="1.1">
                                <g fill="#F5C518">
                      ...
                      <div  class="swiper-slide"  style="width: 167px; margin-left: 1px"  role="group"  aria-label="2 / 10">
                        <a  href="#"  class="main-item w-100 d-block overflow-hidden position-relative">
                          ...
                          <div  class="img-cover w-100 h-100 position-absolute start-0 top-0">
                            ...
                            <div class="imdb-rate">
                              <svg  id="home_img"  xmlns="http://www.w3.org/2000/svg"  width="30"  height="30"  viewBox="0 0 64 32"  version="1.1">
                                <g fill="#F5C518">
                                  <rect  x="0"  y="0"  width="100%"  height="100%"  rx="4"></rect>
                                </g>
                                <g  transform="translate(8.000000, 7.000000)"  fill="#000000"  fill-rule="nonzero">
                  ...
                  <div  class="slider-navigation w-100 h-100 d-flex position-absolute start-0 top-0 align-items-center justify-content-between">
                    <span  class="prev position-relative d-inline-flex justify-content-center align-items-center"  tabindex="0"  role="button"  aria-label="Previous slide"  aria-controls="swiper-wrapper-a0cf471def17d42b"  aria-disabled="false">
                      <i class="fa-solid fa-angle-right"></i>
                    </span>
                    <span  class="next position-relative d-inline-flex justify-content-center align-items-center"  tabindex="0"  role="button"  aria-label="Next slide"  aria-controls="swiper-wrapper-a0cf471def17d42b"  aria-disabled="false"  >
            ...
            <div class="sidebar-box d-block w-100">
              <div  class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  ...
                  <div class="content">
                    <span class="d-block">فیلم های ماجراجویی</span>
                  </div>
                </div>
              </div>
              <div class="box-content d-block position-relative">
            ...
            <div class="sidebar-box d-block w-100">
              <div class="box-headline w-100 d-flex justify-content-between align-items-center">
                <div class="title d-inline-flex align-items-center">
                  ...
                  <div class="content">
                    <span class="d-block">سریال های جنایی</span>
                  </div>
                </div>
              </div>
              <div class="box-content d-block position-relative">
                <div class="post-slider grid_slider">
