          ...
          <form  action=""  class="desk-adv w-100 d-block position-relative">
            ...
            <div  class="data w-100 d-flex align-items-center justify-content-between h-100">
              <div  class="input-box input-radio d-inline-flex justify-content-between">
                <span  class="radio_type d-inline-flex align-items-center active"  data-value="all"  >همه</span>
                <span  class="radio_type d-inline-flex align-items-center"  data-value="movies"  >فیلم</span>
                <span  class="radio_type d-inline-flex align-items-center"  data-value="series"  >سریال</span>
              ...
              <div  class="input-box input-select d-inline-flex align-items-center justify-content-center">
                ...
                <div class="nice-select nice" tabindex="0">
                  <span class="current" id="genr-btn">ژانر</span>
                  <ul class="list" id="genr-list">
                    <li data-value="all" class="option">همه</li>
                    <li data-value="اکشن" class="option">اکشن</li>
                    <li data-value="بیوگرافی" class="option">بیوگرافی</li>
                    <li data-value="تاریخی" class="option">تاریخی</li>
                    <li data-value="جنایی" class="option">جنایی</li>
                    <li data-value="درام" class="option">درام</li>
                    <li data-value="علمی تخیلی" class="option">علمی تخیلی</li>
                    <li data-value="فانتزی" class="option">فانتزی</li>
                    <li data-value="ماجراجویی" class="option">ماجراجویی</li>
                    <li data-value="هیجان انگیز" class="option">هیجان انگیز</li>
                  </ul>
                </div>
              </div>
              ...
              <div  class="input-box input-more d-inline-flex align-items-center justify-content-center">
                <button class="more-filter d-flex align-items-center">
                  <span class="title d-inline-block text-nowrap"  >فیلتر های بیشتر</span>
                  <i  class="fa-light fa-bars-filter d-inline-flex align-items-center justify-content-center"></i>
                </button>
              </div>
              ...
              <div class="input-box input-select">
                ...
                <div class="nice-select nice" tabindex="0">
                  ...
                  <ul class="list"  style="right: 0;">
                    <li data-value="all" class="option">همه</li>
                    <li data-value="آلمان" class="option">آلمان</li>
                    <li data-value="آمریکا" class="option">آمریکا</li>
                    <li data-value="اسپانیا" class="option">اسپانیا</li>
                    <li data-value="استرالیا" class="option">استرالیا</li>
                    <li data-value="انگلستان" class="option">انگلستان</li>
                    <li data-value="چين" class="option">چين</li>
                    <li data-value="فرانسه" class="option">فرانسه</li>
                    <li data-value="کانادا" class="option">کانادا</li>
                    <li data-value="کره جنوبی" class="option">کره جنوبی</li>
                    <li data-value="مالت" class="option">مالت</li>
                    <li data-value="مراکش" class="option">مراکش</li>
                    <li data-value="نیوزلند" class="option">نیوزلند</li>
                  </ul>
                </div>
              </div>
              <div class="input-box input-select">
                ...
                <div class="nice-select nice" tabindex="0">
                  ...
                  <ul class="list">
                    <li data-value="all" class="option">همه</li>
                    <li data-value="R" class="option">R</li>
                    <li data-value="Not Rated" class="option">Not Rated</li>
                    <li data-value="PG-13" class="option">PG-13</li>
                    <li data-value="PG" class="option">PG</li>
                    <li data-value="TV-MA" class="option">TV-MA</li>
                    <li data-value="TV-14" class="option">TV-14</li>
                    <li data-value="TV-PG" class="option">TV-PG</li>
                    <li data-value="G" class="option">G</li>
                    <li data-value="Unrated" class="option">Unrated</li>
                    <li data-value="Passed" class="option">Passed</li>
                    <li data-value="Approved" class="option">Approved</li>
                    <li data-value="TV-G" class="option">TV-G</li>
                    <li data-value="TV-Y7" class="option">TV-Y7</li>
                    <li data-value="TV-Y" class="option">TV-Y</li>
                    <li data-value="TV-Y7-FV" class="option">TV-Y7-FV</li>
                    <li data-value="GP" class="option">GP</li>
                    <li data-value="NC-17" class="option">NC-17</li>
                    <li data-value="X" class="option">X</li>
                    <li data-value="M" class="option">M</li>
                    <li data-value="MA-17" class="option">MA-17</li>
                    <li data-value="T" class="option">T</li>
                    <li data-value="TV-13" class="option">TV-13</li>
                    <li data-value="AO" class="option">AO</li>
                  </ul>
                </div>
              </div>
